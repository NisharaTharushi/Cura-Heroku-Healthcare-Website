...
class appointment_page:
    ...
    def click_make_appointment(self):
        ...
        print(
            "Make Appointment button clicked and open new URL: "
    ...
    def click_apply_button(self):
        ...
        print(
            "Book appointment button clicked and open new URL: "
            + self.driver.current_url
        )
    ...
    def click_Book_button(self):
        ...
        if "Appointment Confirmation" in self.driver.page_source:
            print(
                "Appointment Booked Successfully Appointment Confirmation text displayed"
            )
        else:
    ...
    def click_go_to_homepage(self):
        ...
        print(
            "Go to Homepage button clicked and open new URL: " + self.driver.current_url
        )
        print("")
